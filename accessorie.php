...
<head>
    ...
    <title>Welcome To Jaipur Window - Accessories All Products | Jaipur Window</title>
            ...
            <div class="row">
                ...
                <div id="content" class="col-sm-9  all-blog my-baby-pink" style="padding: 20px 40px;">
                    ...
                    <div id="items-container">
                        <?php
                        $i = 0;
                        $statement = $pdo->prepare("SELECT * FROM tbl_accessroies WHERE a_is_active = 1 ORDER BY a_name ASC");
                        $statement->execute();
                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                        foreach ($result as $row) {
                            $i++;
                                            ...
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <a href="accessorie-details.php?a_id=<?= $row['a_id']; ?>" class="thumb-image">
                                                        <?php if (!empty($row['a_photo']) && file_exists('./admin/uploads/accessroies/' . $row['a_photo'])) : ?>
                                                            <img src="./admin/uploads/accessroies/<?= ($row['a_photo']); ?>" alt="<?= ($row['a_name']); ?>" title="<?= ($row['a_name']); ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                        <?php else : ?>
                                                            <img src="assets/jaipur-new-logo.png" alt="<?= ($row['a_name']); ?>" title="<?= ($row['a_name']); ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                        <?php endif; ?>
                                                    </a>
                                            ...
                                            <div class="product-description">
                                                <div class="caption">
                                                    <div class="title-rating clearfix">
                                                        <h4 class="product-title"><a class="food-title2" href="accessorie-details.php?a_id=<?= $row['a_id']; ?>"><?= $row['a_name']; ?></a></h4>
                                                    </div>
