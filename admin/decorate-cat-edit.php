...
if (isset($_POST['form1'])) {
    ...
    if (empty($_POST['cat_name'])) {
        ...
        $statement = $pdo->prepare("SELECT * FROM tbl_decorate_category WHERE cat_name=? AND cat_id!=?");
    ...
    if ($valid == 1) {
        ...
        if ($path != '') {
            ...
            // Remove old image
            if (file_exists('./uploads/decorate/category/' . $current_image) && $current_image != '') {
                unlink('./uploads/decorate/category/' . $current_image);
            }
        } else {
        ...
        // Update the database
        $statement = $pdo->prepare("UPDATE tbl_decorate_category SET cat_name=?, url=?, cat_image=?, status=? WHERE cat_id=?");
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <img src="./uploads/decorate/category/<?php echo $current_image; ?>" alt="<?php echo $current_name; ?>" style="width:100px;">
                            </div>
                        </div>
                        <div class="form-group">
