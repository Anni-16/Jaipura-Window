...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		move_uploaded_file($path_tmp, './uploads/wear/' . $final_name);
		...
		$statement = $pdo->prepare("UPDATE tbl_product SET p_code = ? , url=? WHERE p_id = ?");
		$statement->execute([$p_code, $url, $ai_id]);
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label"> Category Sub Name <span>*</span></label>
							<div class="col-sm-4">
