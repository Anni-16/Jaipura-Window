		...
		<footer style="padding-left:500px; padding-top:10px;">
			<p class="clr-white" style="font-size:18px;">Jaipur Window ©
				<script>
		...
		<script>
			...
			// To decorate Category Filter 
			$(".decorate-cat").on('change', function() {
				var id = $(this).val();
				var dataString = 'id=' + id;
				$.ajax({
					type: "POST",
					url: "get-decorate-sub-category.php",
					data: dataString,
					cache: false,
					success: function(html) {
						$(".decorate-sub-cat").html(html);
					}
				});
			});
