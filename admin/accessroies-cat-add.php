...
if (isset($_POST['form1'])) {
    ...
    if (empty($_POST['cat_name'])) {
        ...
        $statement = $pdo->prepare("SELECT * FROM tbl_accessroies_category WHERE cat_name=?");
    ...
    if ($valid == 1) {
        ...
        $statement = $pdo->prepare("INSERT INTO tbl_accessroies_category (cat_name, cat_image,status) VALUES (?, ?, ?)");
        ...
        $statement = $pdo->prepare("UPDATE tbl_accessroies_category SET url=? WHERE cat_id=?");
