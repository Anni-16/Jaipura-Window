...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="wear-add.php" class="btn btn-primary btn-sm">Add Wear</a>
    </div>
</section>
                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td style="width:82px;">
                                    <img src="./uploads/wear/<?php echo $row['p_featured_photo']; ?>" 
                                         alt="<?php echo $row['p_name']; ?>" 
                                         style="width:80px;">
                                </td>
                                <td><?php echo $row['p_code']; ?></td>
                                <td><?php echo $row['p_name']; ?></td>
                                <td>Rs. <?php echo $row['p_old_price']; ?></td>
                                ...
                                <td>
                                    <a href="wear-edit.php?id=<?php echo $row['p_id']; ?>" 
                                       class="btn btn-primary btn-xs">Edit</a>
                                    <a href="#" class="btn btn-danger btn-xs" 
                                       data-href="wear-delete.php?id=<?php echo $row['p_id']; ?>" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! This product will be deleted from the order table, payment table, size table, color table, and rating table as well.</p>
            </div>
