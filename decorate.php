...
<head>
    ...
    <title>Welcome To Jaipur Window - Wear All Products | Jaipur Window</title>
        ...
        <div class="breadcrumb-main">
            <div class="container">
                <div class="breadcrumb-container">
                    <h2 class="page-title">Decorate</h2>
                    <ul class="breadcrumb">
            ...
            <div class="row">
                ...
                <div id="content" class="col-sm-9  all-blog my-baby-pink" style="padding: 20px 40px;">
                    <div class="category-refine">
                        <h1><strong>All Decorates Products</strong></h1>
                    </div>
                    <br>
                    ...
                    <div id="items-container">
                        <?php
                        $i = 0;
                        $statement = $pdo->prepare("SELECT * FROM tbl_decorate WHERE d_is_active = 1 ORDER BY d_name ASC");
                        $statement->execute();
                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                        foreach ($result as $row) {
                            $i++;
                                            ...
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <a href="decorate-details.php?d_id=<?= $row['d_id']; ?>" class="thumb-image">
                                                        <?php if (!empty($row['d_photo']) && file_exists('./admin/uploads/decorate/' . $row['d_photo'])) : ?>
                                                            <img src="./admin/uploads/decorate/<?= ($row['d_photo']); ?>" alt="<?= ($row['d_name']); ?>" title="<?= ($row['d_name']); ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                        <?php else : ?>
                                                            <img src="assets/jaipur-new-logo.png" alt="<?= ($row['d_name']); ?>" title="<?= ($row['d_name']); ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                        <?php endif; ?>
                                                    </a>
                                            ...
                                            <div class="product-description">
                                                <div class="caption">
                                                    <div class="title-rating clearfix">
                                                        <h4 class="product-title"><a class="food-title2" href="decorate-details.php?d_id=<?= $row['d_id']; ?>"><?= $row['d_name']; ?></a></h4>
                                                    </div>
                                                    <div class="price-cartbtn clearfix">
                                                        <p class="food-price">Rs.<?= $row['d_current_price']; ?></p>
                                                    </div>
