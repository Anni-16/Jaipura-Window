...
if (isset($_GET['cat_id'])) {
    ...
    $statement = $pdo->prepare("SELECT * FROM tbl_decorate_category WHERE cat_id = ? AND status = 1");
...
<head>
    ...
    <title>Welcome To Jaipur Window - Decorate Categories | Jaipur Window</title>
            ...
            <div class="row">
                ...
                <div id="content" class="col-sm-9  all-blog my-baby-pink" style="  padding: 20px 40px;">
                    <div class="category-refine">
                        <h1><strong>Decorate Categories Products</strong></h1>
                    </div>
                    <br>
                    ...
                    <div id="items-container">
                        ...
                        $statement = $pdo->prepare("SELECT * FROM tbl_decorate_sub_category WHERE cat_id = ? AND show_status = 1");
                                        ...
                                        <div class="food-cart-box" data-product-id="1">
                                            <div class="food-box">
                                                <div class="product-thumb">
                                                    <div class="image">
                                                        <a href="decorate-filter.php?sub_cat_id=<?= $subcategory['sub_cat_id']; ?>" class="thumb-image">
                                                            <?php if (!empty($subcategory['sub_cat_image'])) : ?>
                                                                <img src="./admin/uploads/decorate/subcategory/<?= $subcategory['sub_cat_image']; ?>" alt="<?= $subcategory['sub_cat_name']; ?>" title="<?= $subcategory['sub_cat_name']; ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                            <?php else : ?>
                                                                <img src="assets/jaipur-new-logo.png" alt="<?= $subcategory['sub_cat_name']; ?>" title="<?= $subcategory['sub_cat_name']; ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                            <?php endif; ?>
                                                ...
                                                <div class="product-description">
                                                    <div class="caption">
                                                        <div class="title-rating clearfix">
                                                            <h4 class="product-title"><a class="food-title2" href="decorate-filter.php?sub_cat_id=<?= $subcategory['sub_cat_id']; ?>"><?= $subcategory['sub_cat_name']; ?></a></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
