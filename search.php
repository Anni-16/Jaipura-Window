...
<head>
    ...
    <title>Welcome To Jaipur Window -Serach All Products | Jaipur Window</title>
...
<body class="categorypage" style="background-image: url(./assets/images/banners/banner-main.jpeg); background-repeat: no-repeat; width: 100%; height: auto;  background-attachment: fixed; background-position: center; overflow-x: hidden !important">
    ...
    <div class="blog-section donuts">
        <div class="container">
            <div class="row">
                            ...
                            <ul class="list-unstyled parent" id="select-category">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                                    <div class="accordion-body">
                                                        ...
                                                        ?>
                                                            <li>
                                                                <a href="wear-sub-category.php?url=<?= $row1['url']; ?>" class="list-group-item">&nbsp;&nbsp;
                                                                    <?= $row1['mcat_name']; ?></a>
                                                            </li>
                                                        <?php } ?>
                                                    </div>
                                ...
                                <li class="has-more-category">
                                    ...
                                    <ul class="list-unstyled child-categories group">
                                        ...
                                        foreach ($categories as $category) { ?>
                                            <li>
                                                <a href="decorate-category.php?url=<?= $category['url']; ?>" class="list-group-item">&nbsp;&nbsp; <?= $category['cat_name']; ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <li class="has-more-category">
                                    ...
                                    <ul class="list-unstyled child-categories group">
                                        ...
                                        ?>
                                            <li>
                                                <a href="accessorie-category.php?url=<?= $row['url']; ?>" class="list-group-item">&nbsp;&nbsp; <?= $row['cat_name']; ?></a>
                                            </li>
                                        <?php }
                                        ?>
                                    </ul>
                ...
                <div id="content" class="col-sm-9  all-blog" style="background-color: white; padding: 20px 40px;">
                    <div class="category-refine">
                        <h1><strong>All Accessories Products</strong></h1>
                    </div>
                    <br>
                    ...
                    <div class="category-row row">
                        ...
                        try {
                            ...
                            if (!empty($searchQuery)) {
                                $sql = "
            (SELECT p_id AS id, p_name AS name, p_current_price AS price, p_featured_photo AS product_image, 'Product' AS category FROM tbl_product WHERE p_name LIKE :search)
            UNION
            (SELECT d_id AS id, d_name AS name, d_current_price AS price, d_photo AS product_image, 'Decorate' AS category FROM tbl_decorate WHERE d_name LIKE :search)
            UNION
            (SELECT a_id AS id, a_name AS name, a_current_price AS price, a_photo AS product_image, 'Accessories' AS category FROM tbl_accessroies WHERE a_name LIKE :search)
            ORDER BY name ASC;
        ";
                                ...
                                if ($results) {
                                    ...
                                    foreach ($results as $row) {
                                        $image_path = 'assets/images/logo.png'; // Default image

                                        if (!empty($row['product_image'])) {
                                            $image_accessories = "admin/uploads/accessroies/{$row['product_image']}";
                                            $image_wear = "admin/uploads/wear/{$row['product_image']}";
                                            $image_decorate = "admin/uploads/decorate/{$row['product_image']}";
                        ...
                        ?>
                                        <div class="item">
                                            <div class="product-layout product-list col-xs-12" style="padding-top: 100px;">
                                                <div class="food-cart-box" data-product-id="<?= $row['id']; ?>">
                                                    <div class="food-box">
                                                        <div class="product-thumb">
                                                            <div class="image">
                                                                <img src="<?= $image_path ?>" alt="<?= $row['name'] ?>" class="img-responsive" style="width:100%; height:auto; object-fit: cover;" p />
                                                            ...
                                                            <div class="product-description">
                                                                <div class="caption">
                                                                    <div class="title-rating clearfix">
                                                                        <h4 class="product-title food-title2" ><?= $row['name'] ?></h4>
                                                                    </div>
    ...
    <!-- Main js -->
    <script type="text/javascript" src="assets/js/my-cart.js"></script>
