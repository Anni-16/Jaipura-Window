...
<head>
    ...
    <title>Category - Saree HTML Template - NariSaree</title>
            ...
            <div class="row">
                ...
                <div id="content" class="col-sm-9  all-blog my-baby-pink" style="  padding: 20px 40px;">
                    <div class="category-refine">
                        <h1><strong>All Wear Products</strong></h1>
                    </div>
                    <br>
                                            ...
                                            <div class="product-thumb">
                                                <div class="image">
                                                    <a href="wear-details.php?p_id=<?= $row['p_id']; ?>" class="thumb-image">
                                                        <?php if (!empty($row['p_featured_photo']) && file_exists('./admin/uploads/wear/' . $row['p_featured_photo'])) : ?>
                                                            <img src="./admin/uploads/wear/<?= ($row['p_featured_photo']); ?>" alt="<?= ($row['p_name']); ?>" title="<?= ($row['p_name']); ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                        <?php else : ?>
                                                            <img src="assets/jaipur-new-logo.png" alt="<?= ($row['p_name']); ?>" title="<?= ($row['p_name']); ?>" class="food-img" style="width:100%; height:auto; object-fit: cover;">
                                                        <?php endif; ?>
                                                    </a>
                                            ...
                                            <div class="product-description">
                                                <div class="caption">
                                                    <div class="title-rating clearfix">
                                                        <h4 class="product-title"><a class="food-title2" href="wear-details.php?p_id=<?= $row['p_id']; ?>"><?= $row['p_name']; ?></a></h4>
                                                    </div>
                                                    <div class="price-cartbtn clearfix">
                                                        <p class="food-price">Rs.<?= $row['p_current_price']; ?></p>
